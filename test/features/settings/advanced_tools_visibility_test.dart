...
void main() {
  ...
  testWidgets('primary shell context hides operator-heavy tools by default', (
    tester,
  ) async {
  ...
  testWidgets('settings exposes deliberate advanced path for operator tools', (
    tester,
  ) async {
    await pumpShell(tester, size: const Size(390, 1000));
    ...
    expect(find.text('Recent events'), findsAtLeastNWidgets(1));
  });
}
